...
<br><br>
    ...
    <tbody>
			<?php
	$query=mysqli_query("select * from post")or die(mysqli_error());
    ...
    <td width="50">
	<?php 
	$comment_query=mysqli_query("select * from comment where post_id='$id'")or die(mysqli_error());
	...
	<?php $comment=mysqli_query("select * from comment where post_id='$id'")or die(mysqli_error());
	...
	<?php  } ?>
		...
		mysqli_query("insert into post (content) values('$post_content')")or die(mysqli_error());
